...
name: vault-sync
description: >-
  Native Windsurf (Cascade) Skill to archive the current coding session into the Obsidian vault.
  To install: Copy this file's contents into your `.windsurfrules` or prompt it when you finish a task.
---
...
4. **Update Project Note**: Read the project note at `C:\Users\nevin\Desktop\obsiclaude\claude\01_Projects\<project-name>\README.md`.
