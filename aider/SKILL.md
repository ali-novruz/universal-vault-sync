...
name: vault-sync
description: >-
  Native Aider Skill to archive the current coding session into the Obsidian vault.
  To install: Pass this file to Aider using the `--message` flag or load it as an architect prompt.
---
