...
name: vault-sync
description: >-
  Native Cursor Skill to archive the current coding session into the Obsidian vault.
  To install: Copy this file's contents into your `.cursorrules` or prompt it when you finish a task.
---
